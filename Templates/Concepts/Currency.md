...
> When generating a currency system, create a complete economic foundation including physical currency, value standards, and trade practices. Consider who mints the currency, how it's valued, where it's accepted, and how it interacts with other economic systems. Currencies should feel authentic with denominations that make practical sense and histories that explain their development.

## Overview
> Write 3-4 sentences establishing this currency's identity—what it is, who issues it, its stability and acceptance, and what distinguishes it from other currencies in the region.

## Classification

### Type
**Currency Type:** (Coined Money / Paper Currency / Trade Goods / Credit System / Mixed System / Other)

**Material Basis:** (Gold Standard / Silver Standard / Fiat / Commodity-backed / Other)

### Issuing Authority
**Minted/Issued By:** (Government / Guild / Temple / Trade Consortium / Independent Mint / Other)

**Controlling Entity:**

### Status
**Stability:** (Highly Stable / Stable / Fluctuating / Unstable / Volatile)

**Acceptance:** (Universal / Regional / Limited / Restricted / Declining)

## Denominations

### Coin Types
| Denomination | Name | Material | Value | Weight | Description |
|--------------|------|----------|-------|--------|-------------|
| Smallest | | | | | |
| Small | | | | | |
| Standard | | | | | |
...
**Foreign Exchange:**
List exchange rates with major foreign currencies:
-

### Paper/Credit Instruments
*If applicable:*
| Instrument | Value Range | Issuer | Acceptance |
|------------|-------------|--------|------------|
| | | | |

## Physical Description

### Standard Coin Design
**Primary Coin ([Standard denomination]):**
- **Obverse (Front):** Describe imagery—ruler portrait, national symbol, deity, etc.
- **Reverse (Back):** Describe imagery—value, motto, heraldic device, etc.
- **Edge:** (Smooth / Reeded / Lettered / Decorated)
- **Size:** Diameter and thickness
- **Weight:**
- **Purity:**

### Design Variations
Describe how denominations differ:
- Smallest:
- Small:
- Large:
- Largest:
...
### Minting Authority
**Official Mints:**
| Mint | Location | Output | Specialty |
|------|----------|--------|-----------|
| | | | |

### Production
**Minting Process:**
Describe in 2-3 sentences how coins are produced.
...
### Security Features
List anti-counterfeiting measures:
-
-
...
### Backing
**Value Basis:** Describe what gives this currency its value—precious metal content, government backing, trade utility, etc.

### Purchasing Power
Describe what common items cost:

| Item | Price | Notes |
|------|-------|-------|
| Loaf of bread | | |
| Day's lodging (common) | | |
| Day's labor (unskilled) | | |
| Day's labor (skilled) | | |
| Horse | | |
| Weapon (common sword) | | |
| Spell component (common) | | |

### Historical Value
Describe how the currency's value has changed over time:
...
### Acceptance Levels
| Location Type | Acceptance | Notes |
|---------------|------------|-------|
| Major cities | | |
| Towns | | |
| Rural areas | | |
...
List goods commonly used for trade alongside or instead of coins:

| Good | Standard Unit | Approximate Value | Where Accepted |
|------|---------------|-------------------|----------------|
| | | | |
| | | | |
| | | | |
...
### Barter Practices
Describe in 2-3 sentences when and how barter is used instead of currency.
...
### Inflation/Deflation
Describe current economic pressures:

### Wealth Distribution
How does access to currency vary across society?

### Trade Facilitation
How does this currency enable commerce?

## Regional Variations

### Local Currencies
| Region | Local Currency | Exchange Rate | Status |
|--------|----------------|---------------|--------|
| | | | |

### Foreign Currencies
| Currency | Origin | Exchange Rate | Acceptance |
|----------|--------|---------------|------------|
| | | | |
...
**Types Available:** (Money Changers / Merchant Banks / Temple Banks / Guild Banks / Royal Treasury / Other)

### Services
List banking services available:
- Deposits:
- Loans:
- Letters of credit:
- Currency exchange:
...
### Credit Systems
Describe any credit or debt instruments:

## Counterfeiting

### Common Methods
List known counterfeiting techniques:
-
...
### Notable Cases
Describe significant counterfeiting incidents:

## History

### Origins
Write 3-4 sentences about how this currency was established—when, why, by whom, and what it replaced.

### Evolution
Describe major changes over time:
1. **[Era/Event]:** Change and impact
2. **[Era/Event]:**

### Reforms
List significant monetary reforms:
-

### Crises
Describe any currency crises or economic disasters:

## Current Status

### Present Condition
Describe in 2-3 sentences the current state of the currency.
...
## Notes
Additional details, references, and ideas for economic integration.
