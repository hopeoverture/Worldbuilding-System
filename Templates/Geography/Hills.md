...
> When generating hills, create rolling terrain that breaks the monotony of flatlands without the severity of mountains. Include the valleys between, the villages that dot the slopes, and the resources hidden within. Hills should feel pastoral or wild, depending on settlement—gentle country or bandit-haunted wilderness.

## Overview
> Write 3-4 sentences establishing this hill region's character—its extent, the feel of the landscape, and what makes it notable.

## Classification

### Type
**Hill Type:** (Rolling / Rugged / Wooded / Bare / Cultivated / Wild)

### Scale
**Size:** (Small Area / Medium / Large / Extensive)
...
### Terrain
**Character:** (Gentle / Moderate / Steep / Mixed)

**Highest Hills:**
| Name | Elevation | Notable For |
|------|-----------|-------------|
| | | |
| | | |

### Valleys
| Valley | Character | Settlements |
|--------|-----------|-------------|
| | | |
| | | |
...
### Natural Defenses
How do hills aid defense?

### Fortifications
| Fortification | Type | Controller |
|---------------|------|------------|
| | | |
| | | |

### Hiding Places
Where do people or bandits hide?
-
...
### Adventure Sites
Caves, lairs, dungeons:
-

## History

### Geological History
How did these hills form? (2-3 sentences)
...
### Legends
Stories about the hills:
-

## Current Situation

### Territorial Control
Who claims these hills?
-
