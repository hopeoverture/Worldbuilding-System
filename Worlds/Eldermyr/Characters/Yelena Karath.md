...
class: Warlock (Great Old One) / Wizard (Divination)
level: 12
challenge_rating: 10
proficiency_bonus: +4
# Ability Scores
...
role: Spymistress and sorceress
---
...
- **Species:** Human, with pronounced corruption
- **Age:** 42, but the corruption makes her age hard to determine; sometimes looks thirty, sometimes looks sixty
- **Height/Build:** 5'6", unnaturally thin; doesn't seem to eat much anymore
- **Skin/Eyes:** Pale as bone; eyes are pale gray, almost colorless, and seem to see things that aren't there
- **Hair:** Prematurely white, worn long and loose; sometimes moves when there's no wind
- **Distinguishing Features:** Whispers to herself constantly; doesn't cast a shadow in certain light; hands are always cold
...
### Skills
**Proficiencies:** Arcana (+12), Investigation (+8), Perception (+6), Insight (+6), Stealth (+6)
...
- **Immunities:** Cannot be surprised (always watching)
- **Vulnerabilities:** Radiant damage (the corruption burns)
...
|------|--------------|--------|------|------------|
| Eldritch Blast | +7 | 3d10+3 | Force | 120 ft., 3 beams |
...
3. **Portent (Divination Wizard):** Each morning, rolls 2d20 and records results. Can replace any attack roll, save, or check with a recorded result.

## Spellcasting

### Spellcasting
- **Spellcasting Ability:** Intelligence (Wizard) / Charisma (Warlock)
- **Spell Save DC:** 16
- **Spell Attack Bonus:** +8

### Warlock Spells (Pact Magic)
**Slots:** 3 × 5th level (short rest recovery)

**Spells Known:** Armor of Agathys, Hex, Detect Thoughts, Hold Person, Clairvoyance, Hunger of Hadar, Evard's Black Tentacles, Dominate Person

### Wizard Spells
**Slots:** 4/3/3/3/2/1

**Prepared Spells:**
- Cantrips: Chill Touch, Minor Illusion, Prestidigitation, Message
- 1st: Shield, Detect Magic, Comprehend Languages
- 2nd: See Invisibility, Misty Step, Mind Spike
- 3rd: Counterspell, Dispel Magic, Sending
...
### Portrait (Bust)
**Prompt:**
> Portrait bust of a corrupted human sorceress, female, age indeterminate between thirty and sixty. Prematurely white hair worn long and loose, seems to move slightly. Pale gray almost colorless eyes that seem to look through the viewer. Bone-pale skin, unnaturally thin features. Expression is cold curiosity, the detachment of a scholar studying something fascinating and horrifying. Wearing black and gray hooded robes, silver amulet (The Watcher's Eye) at throat. Background: blurred darkness with hints of forbidden symbols. Cold, unsettling lighting with shadows that don't match the light source. Hyper-realistic digital art, photorealistic rendering, dramatic atmosphere, 8K quality. Fantasy dark witch portrait.

## Connections

### Geography
- **Base:** [[Chernogrod]]
- **Watches:** [[The Ashen Fields]]

### Characters
- **Brother:** [[Lord Draven Karath]]
- **Nephew:** Aleksei Karath
- **Patron:** [[The Unnamed]]

### Organizations
- **House:** [[House Karath]]
- **Runs:** The Karath spy network

### Concepts
- **Magic:** [[Magic of Eldermyr]] (Forbidden: divination through dark means, mind magic)
- **Patron:** [[The Unnamed]]
