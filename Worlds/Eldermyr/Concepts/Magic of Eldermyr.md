...
magic_type: Multiple traditions
source: Divine, Bloodline, Academic, Spiritual, Forbidden
prevalence: Rare (1 in 1,000)
# Mechanics
casting_method: Varies by tradition
limitations: No true resurrection, no immortality, no time travel, always costs
---

# Magic of Eldermyr

> *"Magic is not a gift. It is a debt you pay with your own flesh, your own years, your own sanity. Those who think otherwise have never cast a spell that mattered."*
> — Attributed to Archmage Valdros the Grey

## Overview

Magic in Eldermyr is rare, powerful, and dangerous. Perhaps one person in a thousand carries the spark—and of those, most never develop it beyond hedge-tricks and minor cantrips. True practitioners are remarkable figures: valued by lords, watched by the [[The Faith of the Three|Faith]], and viewed with a mix of awe and fear by common folk.
...
Magic in Eldermyr falls into five broad traditions, each with its own source, methods, and social standing:
...
| **Forbidden** | Demonic pacts, necromancy | Hunted | Warlocks, Necromancers |

### Underlying Mechanics

All magic, regardless of tradition, operates on certain shared principles:
...
Magic reshapes reality through will, knowledge, and sacrifice. The caster imposes their desire on the world, paying for the change with their own life force and whatever components the working requires. The greater the effect, the greater the cost. There are no shortcuts—only debts deferred or paid by others.

### Accessing Magic by Tradition
...
- Cannot be taught to those without the blood
- Inherited memory sometimes provides ancestral knowledge through dreams
- Different bloodlines carry different affinities

**Academic Magic:**
- Learned through years of study with a master or from rare texts
- Requires natural aptitude plus discipline
- Most structured and understood form of magic
- Knowledge is hoarded and rarely shared freely
...
- Or through necromantic rituals that violate the dead
- Power is quick and potent—but the costs are hidden at first
- Always corrupts the practitioner

### Casting Methods

**Verbal Components:** Most magic requires spoken words—invocations, prayers, true names, or words of power. Silent casting is possible for masters but extremely difficult.

**Somatic Components:** Gestures, hand signs, and ritual movements focus magical energy. Bound or restrained mages have difficulty casting.

**Material Components:** Herbs, minerals, blood, rare substances. Academic magic is particularly dependent on components. Divine magic often substitutes holy symbols.

**Focus Items:** Staves, wands, orbs, holy symbols. Not strictly required, but they reduce strain and improve control.

**Ritual Requirements:** Major workings require hours or days of preparation, specific locations, astronomical timing, or multiple participants.

### Schools of Magic

**Sanctioned Schools:**
| School | Effects | Status |
|--------|---------|--------|
| **Healing** | Mending wounds, curing disease, removing poison | Honored, taught by Faith |
| **Divination** | Seeing truth, past, future, hidden things | Valued, carefully watched |
| **Alchemy** | Potions, salves, material transmutation | Respectable trade |
| **Warding** | Protection, barriers, seals, abjuration | High demand |
| **Artifice** | Creating enchanted items | Rare, prestigious |

**Distrusted Schools:**
| School | Effects | Status |
|--------|---------|--------|
| **Illusion** | False sensory experiences | "Liars with power" |
| **Enchantment** | Affecting emotions and thoughts | Borders on forbidden |
| **Transmutation** | Changing one thing to another | Unsettling |
| **Pyromancy** | Fire magic | Valuable in war, dangerous in peace |
| **Geomancy** | Earth and stone magic | Old ways, tolerated |

**Rare Schools:**
| School | Effects | Status |
|--------|---------|--------|
| **Druidism** | Nature communion | Rural, distrusted by Faith |
| **Electromancy** | Storm and lightning | Rare, dramatic |
| **Telepathy** | Mental communication | Very rare bloodline gift |

**Forbidden Schools:**
| School | Effects | Punishment |
|--------|---------|------------|
| **Necromancy** | Animating or contacting dead | Death by burning |
| **Summoning** | Calling entities from beyond | Death by burning |
| **Binding** | Trapping spirits | Death by burning |
| **Biomancy** | Shaping flesh | Imprisonment or death |

### Power Levels

**Cantrips/Minor Effects:**
- Light, minor healing, small flames, simple divination
- Tiring but not dangerous
- Most practitioners never exceed this level

**Moderate Effects:**
- Serious healing, battle magic, useful enchantments
- Requires significant rest afterward
- The level of a competent professional

**Major Effects:**
- Raising wards over buildings, powerful combat magic, complex rituals
- Days of recovery; possible permanent cost
- Master-level work
...
- Perhaps a handful of living practitioners could attempt such things

## Costs & Limitations

### Energy Cost

All magic exacts a price:
- **Minor Casting:** Tiredness equivalent to hard labor
- **Moderate Casting:** Exhaustion requiring hours of rest
- **Major Casting:** Days bedridden; possible lasting fatigue
- **Legendary Casting:** Years of life; permanent damage; death

### Absolute Limitations

What magic CANNOT do in Eldermyr:

| Limitation | Implication |
|------------|-------------|
| **True Resurrection** | Death is final. Undead are not alive. |
| **Immortality** | All things die. Life can be extended, but not forever. |
| **Time Travel** | The past cannot be changed. |
| **Create Life** | Only the gods create true life. |
| **Affect the Gods** | Divine beings are beyond mortal magic. |
| **Free Power** | Magic always costs something. |
| **Destroy Souls** | Souls can be trapped but not unmade. |
| **Heal Everything** | Some wounds, curses, and conditions resist. |

### Protective Factors

Certain things disrupt or resist magic:

- **Cold Iron:** Meteoric iron or iron forged without fire disrupts magical effects
- **Sacred Ground:** Consecrated spaces resist hostile magic
- **True Faith:** Genuine belief provides protection against curses, possession, and mind control
...
**Divine Magic:** Anyone ordained by the [[The Faith of the Three|Faith]] with genuine devotion
**Bloodline Magic:** Only those born to magical lineages
**Academic Magic:** Anyone with aptitude and access to training (rare)
**Spirit Magic:** Those with connection to the dead (bloodline, near-death, ritual)
**Forbidden Magic:** Anyone desperate or foolish enough to bargain
...
| Forbidden | Self-study, dark communion | Quick but costly | Forbidden libraries |

### Practitioner Ranks

**Academic Tradition:**
1. **Apprentice:** Basic cantrips, learning fundamentals
2. **Journeyman:** Competent with one school, can work independently
3. **Master:** Expert in one school, competent in others, takes apprentices
4. **Archmage:** Legendary power, perhaps a dozen living in Eldermyr
...
**Regulated:** Academic magic requires no formal license, but practitioners who cause harm face severe punishment. Nobles are expected to register bloodline mages in their households.
...
Magic is expensive. Potions cost more than a laborer earns in a month. Enchanted items are treasures passed down through generations. Only the wealthy can afford magical services regularly.

This makes mages valuable to nobles and merchants—and creates tension between the Art and common folk who can never access its benefits.
...
### Concepts
- **Associated Religion:** [[The Faith of the Three]]
...
### Characters
- **Historical Figure:** [[The Mad King]]
- **Current Threat:** [[Lord Draven Karath]]
- **Religious Leader:** [[High Confessor Maren]]

### Organizations
- **Regulatory Body:** [[The Faith of the Three]]
- **Noble Houses with Bloodlines:** [[House Valdren]], [[House Thorne]], [[House Karath]]
