...
tags:
  ...
  - eastern-march
  - secret
name: Grimhild's Commission
aliases:
  - The Unnamed Blade
  - The Death of Kings
  - The Forgemaster's Secret
status: in-progress
image:
# 5e Weapon Stats
weapon_type: Longsword
weapon_category: Martial
damage: 1d10 (versatile 1d12)
...
attunement_requirements: Unknown - Grimhild has not revealed the requirements
# Location
location: "[[Hammerhall]]"
...
### Base Weapon
**Base Type:** Longsword (but lighter, faster, perfectly balanced)
...
| Property | Value |
|----------|-------|
| Damage | 1d10 (1d12 versatile) |
| Damage Type | Slashing (and Radiant against undead) |
| Weight | 3 lb. |
| Cost | Priceless |
...
### Classification
- **Rarity:** Legendary
- **Estimated Value:** Beyond price (only one exists)
...
**Undeath's Bane.** Attacks with this weapon deal an additional 2d6 radiant damage to undead creatures. This damage bypasses any resistance or immunity to radiant damage.

**Sever the Bond.** When you damage a creature that is controlling or animating undead, you can attempt to break that control. The target must succeed on a DC 17 Wisdom saving throw or lose control of all undead within 120 feet. This ability can be used three times per day.
...
No one would recognize this weapon. That is deliberate.
...
### Full Weapon
**Prompt:**
> Full view of a perfect longsword, mirror-bright steel without ornamentation. The blade is simple and elegant, single-edged, glowing faintly with inner light. The crossguard is a straight bar of bright steel. The grip is wrapped in white leather. The pommel is a polished steel sphere. No runes, no decoration—pure function, absolute craftsmanship. Displayed on a forge anvil, lit by the glow of coals. The blade seems to reflect light that isn't there. Hyper-realistic digital art, photorealistic rendering, cinematic lighting, rich textures, dramatic atmosphere, depth of field, volumetric lighting, 8K quality, masterful composition. Fantasy legendary weapon illustration.

### Detail Shot
**Prompt:**
> Extreme close-up of a longsword blade, showing the perfect mirror finish of the steel. The edge is honed to supernatural sharpness, visible as a hair-thin line of light. No maker's mark, no engraving—just flawless metalwork. The surface reflects the viewer's face perfectly. A faint luminescence emanates from within the steel. Master smithing beyond mortal skill. Hyper-realistic digital art, photorealistic rendering, cinematic lighting, rich textures, dramatic atmosphere, depth of field, volumetric lighting, 8K quality, masterful composition. Fantasy weapon detail.

## Connections

### Characters
- **Creator/Smith:** [[Grimhild the Smith]]
- **Current Owner:** [[Grimhild the Smith]]
- **Destined Wielder:** Unknown (possibly a PC)
- **Those Who Would Stop It:** [[Lord Draven Karath]], The Figure

### Geography
- **Place of Forging:** [[Hammerhall]] (sealed forge)
- **Associated Regions:** [[The Eastern March]]
- **Target Location:** [[The Ashen Fields]]

### Organizations
- **Faction Awareness:** None yet
- **Would Want It:** [[The Grey Wardens]], [[The Faith of the Three]]
- **Would Fear It:** [[House Karath]] (Draven's faction)

### History
- **Purpose:** To end the Curse of the Reach
- **Target:** [[The Blackened Crown]]

### Concepts
- **Enchantment Tradition:** Dreams (possibly granted by [[The Faith of the Three|The Chronicler]])
- **Opposing Force:** Necromancy, the undead

### Items
- **Opposed Artifact:** [[The Blackened Crown]]
- **Related:** [[Thornbane]] (both March-forged legendary weapons)
