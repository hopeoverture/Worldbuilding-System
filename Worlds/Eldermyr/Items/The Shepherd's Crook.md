...
sentient: false
# Status
current_owner: "[[High Confessor Maren]]"
current_location: "[[Thornhall]]"
---
...
### Type
**Artifact Type:** Implement (Staff/Holy Symbol)

**Artifact Class:** Major Artifact

### Alignment
**Item Alignment:** Lawful Good (but it responds to the wielder's intent)

### Power Level
**Relative Power:** Legendary

### Sentience
**Sentient:** No (but it channels divine power, which has its own will)

## Appearance

### Physical Description
The Shepherd's Crook is a staff of white ash wood, six feet tall, crowned with a curved crook of silver shaped like a shepherd's hook. The wood is smooth with age, pale as bone, warm to the touch. The silver crook is engraved with symbols of the Shepherd—open hands, hooded figures, wheat sheaves. A single perfect pearl is set where the crook meets the staff, representing the soul under the Shepherd's care.

### Size & Weight
**Dimensions:** 6 feet tall, crook extends 10 inches

**Weight:** 4 pounds (feels lighter to true believers)
...
**Unknown Materials:** The core of the staff contains a fragment of the first High Confessor's fingerbone
...
- The single perfect pearl
- The way it seems to glow in the presence of suffering
- Every faithful Eldermyrian would recognize it
...
|----------|--------|------------|------------|
| Shepherd's Healing | Cast Mass Cure Wounds at 7th level, 3/day | Prayer and gesture | Requires true faith |
| Shield of the Innocent | Create a 30-foot radius sanctuary; evil creatures cannot enter | Prayer, 10 minutes | Once per day, lasts 8 hours |
| Turn the Unquiet | Turn Undead as if 17th-level cleric, advantage on the check | Command and gesture | Twice per day |
| Mercy's Voice | Cast Calm Emotions at will | Speaking words of peace | Does not work on the willing combatant |

### Minor Properties
| Property | Effect |
|----------|--------|
| Guiding Light | Produces daylight equivalent light at will |
| Purify | Food and water touched by the staff becomes pure |
| Blessed Presence | Advantage on Charisma checks to calm or comfort |
...
### Attunement Process
**Ritual/Process:** The staff is passed from the dying High Confessor to their successor during the Rite of Succession

**Duration:** The rite takes one hour; attunement is permanent until death or renunciation
...
### Primary Power
**Name:** Shepherd's Healing

**Effect:**
The High Confessor can channel the Shepherd's mercy to heal the wounded and cure the sick. Three times per day, the bearer can cast Mass Cure Wounds at 7th level (healing up to 6 creatures within 30 feet for 3d8 + spellcasting modifier hit points each).

**Activation:** Prayer and gesture with the staff

**Limitations:** Requires genuine desire to heal; will not function if the Confessor's heart is hardened

### Secondary Powers

#### Shield of the Innocent
**Effect:** The High Confessor can create a sanctuary of peace. A 30-foot radius zone is created where creatures of evil alignment cannot enter willingly (DC 17 Wisdom save to force entry, with 4d10 radiant damage on success).

**Activation:** Ten minutes of prayer

**Limitations:** Once per day; lasts 8 hours or until the Confessor leaves the area

#### Turn the Unquiet
**Effect:** The staff channels the Chronicler's authority over the dead. The bearer turns undead as a 17th-level cleric, with advantage on the check.

**Activation:** Raising the staff and commanding the dead to rest

**Limitations:** Twice per day
...
**Recharge:** Powers refresh at dawn with prayer

**Daily Limits:** As noted per power

### Restrictions
What the artifact cannot do:
- Cannot heal those who refuse healing
- Cannot harm the innocent (the staff will refuse)
- Cannot be used for personal gain

### Costs
**Physical Cost:** The Confessor ages faster (appearance only, not lifespan)

**Mental Cost:** The constant whisper of prayers can be maddening
...
**Circumstances:** Aldwyn created it during the First Concord, unifying the regional faiths

#### How
**Method:** Blessed ash wood from the sacred grove, silver from offerings, a pearl from Aldwyn's mother

**Sacrifice/Cost:** Aldwyn placed a fragment of his own bone within the staff, binding his blessing to all successors
...
- The Shepherd will lead the living against the unliving
...
1. **The Fading Light:** The party notices the staff's glow is weakening. They must investigate what is corrupting the High Confessor—or the staff itself.
...
### Artifact Portrait
**Prompt:**
> The Shepherd's Crook, a staff of bone-white ash wood crowned with a curved silver crook. The silver is engraved with symbols of mercy—open hands, hooded figures. A single perfect pearl glows where crook meets staff. The wood is smooth with centuries of use, warm and living. Soft golden light emanates from the pearl. Displayed in a cathedral setting, light streaming through stained glass. An aura of peace and comfort. Hyper-realistic digital art, photorealistic rendering, cinematic lighting, rich textures, intricate detail on legendary materials and magical effects, dramatic atmosphere, depth of field, volumetric lighting, 8K quality, masterful composition. Fantasy holy relic illustration.

### Artifact in Use
**Prompt:**
> High Confessor Maren, an elderly man in white and gold robes, raising the Shepherd's Crook. Golden light blazes from the pearl as he performs a mass healing. The sick and wounded around him are bathed in warm radiance. But his eyes show something wrong—intensity instead of compassion, ambition instead of service. The light flickers between gold and something harsher. A moment of power that might be blessing or might be judgment. Hyper-realistic digital art, photorealistic rendering, cinematic lighting, rich textures, dramatic atmosphere, depth of field, volumetric lighting, 8K quality, masterful composition. Fantasy religious power illustration.

## Connections

### Characters
- **Creator:** Saint Aldwyn the Merciful (historical)
- **Current Owner:** [[High Confessor Maren]]
- **Notable Wielders:** High Confessor Lyra, High Confessor Erasmus, High Confessor Brennan

### Organizations
- **Guardian Organization:** [[The Faith of the Three]]
- **Created For:** The High Confessor's office

### Geography
- **Place of Creation:** [[Thornhall]] (Grove of the Three)
- **Current Location:** [[Thornhall]]

### History
- **Creation Event:** The First Concord (unification of the Faith)
- **Major Uses:** The Crimson Plague, blessing the Great War alliance

### Concepts
- **Associated Deity:** The Shepherd (aspect of [[The Faith of the Three]])
- **Opposing Force:** The Unnamed, the Blackened Crown, necromancy

### Items
- **Part of Set:** The Confessor's Regalia (Crook, Mitre, Ring)
- **Related Artifacts:** [[The Iron Crown]] (both symbols of legitimate authority)
