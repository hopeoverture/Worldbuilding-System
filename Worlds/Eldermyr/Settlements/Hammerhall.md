...
aliases:
  - The Forge Town
  - The Anvil of the March
  - Grimhild's Town
status: in-progress
image:
# Settlement Details
settlement_type: industrial town
...
## Overview
Hammerhall is where steel is born. Nestled at the base of Iron Falls where the Stahlfluss drops two hundred feet, the town exists for one purpose: to forge the finest weapons and armor in Eldermyr. The [[Forgemasters Guild]] calls this home, and [[Grimhild the Smith]]—the legendary Guildmaster—works in her private forge on something she won't discuss. Day and night, the hammers ring; day and night, the forges glow. Everything in Hammerhall serves the craft.

## Geography

### Location
Hammerhall occupies a narrow valley where Iron Falls thunders down from the highland plateau. The falls power scores of waterwheels, which drive the great hammers that shape Eldermyr's steel. Iron ore flows down from the mountains; finished weapons flow out to arm the realm.

### The Falls
Iron Falls is spectacular—two hundred feet of crashing water that never freezes even in the harshest winter (the forges' heat rises up the valley). The spray catches rainbow light. The roar is constant. Visitors must shout to be heard in the upper town.
...
- **Master Smiths:** Seven masters, each overseeing different production
- **Journeymen:** Hundreds of skilled workers
- **Apprentices:** Eager young forge-workers learning the trade
...
### The Guild Hall
Administrative center and meeting place for the masters. The walls display examples of legendary work—weapons forged by past Guildmasters, some dating back centuries.

### The Great Works
Twelve massive forges powered by the falls, operating in shifts around the clock. The heat is intense; the noise is overwhelming; the output is extraordinary.

### The Anvil
The town's main tavern, named for its most famous feature—an anvil that legendary smiths supposedly worked on, now enshrined in the common room.

### The Testing Ground
Where weapons are proven against armor, targets, and each other. Quality control is absolute; a flawed weapon never leaves Hammerhall.
