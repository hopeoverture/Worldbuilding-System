...
name: Marevento
aliases:
  - The Shipwright's Town
  - Wind Harbor
  - The Second Port
status: in-progress
image:
# Settlement Details
settlement_type: port town
region: "[[The Western Shore]]"
population: 25000
population_range: 20,000-30,000
government_type: Guild Council
ruling_figure: Guildmaster Alonzo Marinetti
primary_race: Human
# Economy
primary_industry: Shipbuilding
...
### Primary Industry
**Shipbuilding:** Marevento builds everything that floats. The Shipwright's Guild employs a third of the town directly and supplies work to half the rest.

### Trade
The town exports ships and ship-related goods. It imports timber, iron, and specialists. Everything serves the yards.

## Notable Locations

### The Great Yards
Where the Valdren Fleet's warships are built. Currently, three new galleys are under construction—but for whom, exactly, remains politically sensitive.

### The Ropewalk
A quarter-mile covered walkway where the realm's strongest ropes are twisted. The Ropemakers' Guild is subordinate to the Shipwrights but just as proud.

### The Admiral's Rest
A tavern frequented by naval officers and wealthy captains. [[Captain Alonzo the Bold]] keeps rooms here when not at sea.
...
### Geography
- **Region:** [[The Western Shore]]
- **Sea:** [[The Trader's Sea]]

### Characters
- **Naval:** [[Captain Alonzo the Bold]]

### Organizations
- **Ruling House:** [[House Valdren]]
- **Guild:** Shipwright's Guild
